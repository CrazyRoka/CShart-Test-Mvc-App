    ...
    public class MenuCardDatabaseInitializer
    {
        ...
        public async Task CreateAndSeedDatabaseAsync()
        {
            if (!s_databaseChecked)
            {
                ...
                {
                    _context.MenuCards.Add(new MenuCard { Name = "Breakfast", Active = true, Order = 1 });
                    _context.MenuCards.Add(new MenuCard { Name = "Vegetarian", Active = true, Order = 2 });
                    _context.MenuCards.Add(new MenuCard { Name = "Steaks", Active = true, Order = 3 });
                }
